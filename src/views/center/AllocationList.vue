<template>
  <div>
    ...
    <el-scrollbar>
      ...
      <el-table :data="allocatioData" class="table" border highlight-current-row stripe>
        ...
        <el-table-column label="操作" width="300">
          <template #default="scope">
            ...
            <el-button type="primary" style="margin-right: 16px" @click="edit(scope.row)">分发</el-button>
